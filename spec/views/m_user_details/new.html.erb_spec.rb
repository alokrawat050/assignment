...
RSpec.describe "m_user_details/new", type: :view do
  before(:each) do
    assign(:m_user_detail, MUserDetail.new(
      :last_name => "MyString",
      :first_name => "MyString",
  ...
  it "renders new m_user_detail form" do
    render

    assert_select "form[action=?][method=?]", m_user_details_path, "post" do
